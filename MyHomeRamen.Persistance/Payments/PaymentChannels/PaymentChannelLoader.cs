...
public partial class PaymentChannelRepository : IPaymentChannelLoader
{
    async Task<PaymentChannel?> IPaymentChannelLoader.ByIdAsync(PaymentChannelId id, CancellationToken cancellationToken)
