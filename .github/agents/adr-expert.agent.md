...
- **Subfolder**: (optional) Specific subfolder within `/docs/adr/` for categorization
...
- Save the file to `/docs/adr/{subfolder}` or `/docs/adr/` with proper naming convention depending on if a subfolder is specified
