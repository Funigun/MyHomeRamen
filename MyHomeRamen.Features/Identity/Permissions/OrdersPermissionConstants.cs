...
public static class OrdersPermissionConstants
{
    ...
    [
        CanAcceptOrder, CanRejectOrder, CanCancelOrder, CanMarkAsComplete, CanMarkAsPrepared,
        CanShowOrdersHistory, CanViewCustomerOrders, CanCancelPayment, CanSplitPayment
    ];
}
