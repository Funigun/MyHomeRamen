...
#pragma warning restore CA5404 // Do not disable token validation checks
    ...
    public static IServiceCollection ReconfigureCache(this IServiceCollection services, string connectionString)
    {
    ...
    public static IServiceCollection ReconfigureClaimsTransformation(this IServiceCollection services)
    {
    ...
    public static void ReconfigureDbContext<T>(this IServiceCollection services, string connectionString)
                 where T : DbContext
    {
