...
public sealed class Product : AuditableEntity, IEntity<ProductId>
{
    ...
    public static Product Create(ProductId id, Guid restaurantId, ProductId originalId, string name, string description, decimal price, string imageUrl, List<Ingredient> baseIngredients, List<Ingredient> customIngredients)
    {
